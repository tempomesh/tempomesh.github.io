...
APP_NAME="8mem"
WHEEL_URL="${EIGHTMEM_WHEEL_URL:-https://8mem.com/app/install/8mem-0.1.4-py3-none-any.whl}"
WHEEL_SHA256="${EIGHTMEM_WHEEL_SHA256:-240757031478500909edfdf86cbe734e5d7d4a5ee520e9c4fc0e31d7b0cd79f3}"
