...
APP_NAME="8mem"
WHEEL_URL="${EIGHTMEM_WHEEL_URL:-https://8mem.com/app/install/8mem-0.1.3-py3-none-any.whl}"
WHEEL_SHA256="${EIGHTMEM_WHEEL_SHA256:-d09ede7b87080a90b8b2269600cbf2ddf3d2d5c1ce7b5ecb502805b0f0f40569}"
